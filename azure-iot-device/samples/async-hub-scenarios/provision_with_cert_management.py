...
async def main():
    # OPTION 1 : When we ask for the key from user ,
    # here my the mere presence of the key we will know that the choice is cert management
    ...
    if registration_result.status == "assigned":
        ...
        x509 = X509(
            cert_file=x509_cert_file, key_file=x509_key_file, pass_phrase=os.getenv("PASS_PHRASE")
        )
